...
import (
	...
	"github.com/openui-backend-go/product-rpc/internal/logic"
...
func (s *ProductServer) Call(ctx context.Context, in *product.CallRequest) (*product.CallResponse, error) {
