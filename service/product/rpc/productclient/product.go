...
type (
	CallRequest    = product.CallRequest
	CallResponse   = product.CallResponse
...
func (m *defaultProduct) Call(ctx context.Context, in *CallRequest, opts ...grpc.CallOption) (*CallResponse, error) {
	client := product.NewProductClient(m.cli.Conn())
